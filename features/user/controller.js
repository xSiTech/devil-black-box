...
export const addUser = async (req,res) => {
    try{
        ...
        const {firstname,lastname,email, mobileNumber, profileImage, latitude, longitude, city, area, state, country} = value;
        ...
        return res.json({status:200 ,data:newUser, message:"New User Added Successfully"});
...
export const allUser = async (req,res) => {
    try{
        ...
        return res.json({status:200 , data: allUser, message:"Get All The Users"});
...
export const showUser = async (req, res) => {
    try {
        ...
        return res.json({status:500 , data:user , message:"Show User Successfully"});
...
export const deleteUser = async (req,res) => {
    try{
        ...
        return res.json({status:500 , message:"User Fully Deleted Successfully"});
    }
}